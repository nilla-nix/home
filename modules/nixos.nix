      ...
      in [
        ...
        in [
          ...
          }
          {
            ...
            message = "You've asked for the home \"${homeName}\" to be activated in the NixOS system \"${name}\", but it isn't valid for \"${value.pkgs.stdenv.hostPlatform.system or value.pkgs.system}\" systems.";
          }
        ]) value.homes)
        (let
